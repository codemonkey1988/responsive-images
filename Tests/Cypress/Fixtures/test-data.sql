...
VALUES (1, 2, 1, 1, 'tt_content', 'image', 1, 'sys_file', '{\"mobile\":{\"cropArea\":{\"height\":0.5488454706927176,\"width\":1,\"x\":0,\"y\":0.15630550621669628},\"selectedRatio\":\"NaN\",\"focusArea\":null},\"desktop\":{\"cropArea\":{\"height\":1,\"width\":0.813,\"x\":0.04,\"y\":0},\"selectedRatio\":\"NaN\",\"focusArea\":null}}');
...
INSERT INTO `sys_file_reference` (`uid`, `pid`, `uid_local`, `uid_foreign`, `tablenames`, `fieldname`, `sorting_foreign`, `table_local`, `crop`)
VALUES (2, 3, 1, 2, 'tt_content', 'image', 1, 'sys_file', '{\"mobile\":{\"cropArea\":{\"height\":0.5488454706927176,\"width\":1,\"x\":0,\"y\":0.15630550621669628},\"selectedRatio\":\"NaN\",\"focusArea\":null},\"desktop\":{\"cropArea\":{\"height\":1,\"width\":0.813,\"x\":0.04,\"y\":0},\"selectedRatio\":\"NaN\",\"focusArea\":null}}');
...
INSERT INTO `sys_file_reference` (`uid`, `pid`, `uid_local`, `uid_foreign`, `tablenames`, `fieldname`, `sorting_foreign`, `table_local`, `crop`)
VALUES (3, 4, 1, 3, 'tt_content', 'image', 1, 'sys_file', '');
